...
exports.AddMemberDto = exports.TeamRole = void 0;
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'User ID to add', example: 'user-123' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], AddMemberDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Team role override', enum: TeamRole, required: false }),
