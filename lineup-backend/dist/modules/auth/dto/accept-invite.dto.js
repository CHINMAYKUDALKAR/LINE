...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Invitation token from email link' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], AcceptInviteDto.prototype, "token", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Password for the new account (min 8 characters)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(8),
    __metadata("design:type", String)
], AcceptInviteDto.prototype, "password", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'User full name (if not already set)' }),
    (0, class_validator_1.IsString)(),
